...
public class CarGasoline extends Car{
    private String model;

    public CarGasoline(String brand, String model, String color, String bodyType, int numberOfWheels, String transmissionType, double engineVolume) {
    ...
    @Override
    public void refuel() {
        System.out.println(model + " заправлен бензином");
    }
