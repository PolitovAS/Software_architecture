...
public class MessengerModel {
    ...
    public void registerUser(String username, String password) {
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("HW_11/src/Users.txt", true))) {
    ...
    public boolean checkCredentials(String username, String password) {
        ...
        try {
            BufferedReader reader = new BufferedReader(new FileReader("HW_11/src/Users.txt"));
            String line;
